...
public class Wavedraw.Window : Gtk.Window {
  ...
  // NOTE: The none-existent commands are written in english, since that's the way I like to program, so bring your english out, 
  // you won't need it (except for the variable names and logging I guess). 
  construct {
